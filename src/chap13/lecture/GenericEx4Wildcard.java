...
public class GenericEx4Wildcard {
	public static void main(String[] args) {
		...
		Student p = new Person("일반");
		Student s = new Student();

		p = s;

		courseStudent.add(new Student());
		coursePerson.add(new Person("kim"));
		coursePerson.add(new Student());
